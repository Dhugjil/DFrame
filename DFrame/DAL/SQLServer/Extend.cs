...
namespace DFrame.DAL.SQLServer
{
    internal static class Extend
    {
        ...
        /// <returns></returns>
        public static string GetWhereSql(this object model)
        {
            if (model == null)
                return " 1 = 0 ";
        ...
        /// <returns></returns>
        public static string GetWhereSql(this List<object> list)
        {
            if (list == null)
                return " 1 = 0 ";
        ...
        /// <returns></returns>
        public static string GetValuesStr(this object obj, string tableName = "")
        {
            if (obj == null)
                return "";
        ...
        /// <param name="tableName">表名</param>
        /// <returns></returns>
        public static string GetKeysStr(this object obj, string tableName = "")
        {
            if (obj == null)
                return "";
        ...
        /// <returns></returns>
        public static string GetSetStr(this object obj, string tableName)
        {
            if (obj == null)
                return "";
