...
namespace DFrame.DAL.MySQL
{
    internal static class Extend
    {
        ...
        /// <returns></returns>
        internal static string GetWhereSql(this object model, string tableName)
        {
            if (model == null)
                return " 1 = 0 ";
        ...
        /// <param name="tableName">表名</param>
        /// <returns></returns>
        internal static string GetWhereSql(this List<object> list, string tableName)
        {
            if (list == null)
                return " 1 = 0 ";
        ...
        /// <returns></returns>
        internal static string GetValuesStr(this object obj)
        {
            if (obj == null)
                return "";
        ...
        /// <param name="obj">新增实体</param>
        /// <returns></returns>
        internal static string GetKeysStr(this object obj)
        {
            if (obj == null)
                return "";
        ...
        /// <returns></returns>
        internal static string GetSetStr(this object obj)
        {
            if (obj == null)
                return "";
